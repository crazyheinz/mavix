        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          ...
          <div className="flex items-start space-x-4 p-6 bg-gradient-card rounded-xl shadow-soft">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Snel testen met MVP's, UX schetsen en experimenten die inzichten opleveren.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start space-x-4 p-6 bg-gradient-card rounded-xl shadow-soft">
            <CheckCircle className="h-6 w-6 text-success mt-1 flex-shrink-0" />
            <div>
              <h3 className="font-semibold mb-2">Meetbare impact</h3>
              <p className="text-sm text-muted-foreground">
                Heldere KPI’s en beslissingen die innovatie laten renderen.
              </p>
            </div>
          </div>
        </div>
